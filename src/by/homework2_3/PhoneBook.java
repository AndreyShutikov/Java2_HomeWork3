            ...
            for (Person person : persons) {
                ...
                ArrayList<String> email = new ArrayList<>();
                    ...
                    static Person[] generatePersons() {
                        ...
                        persons[0] = new Person("Ivanov", "Ivan", "74953334102", "mailrrr@yandex.ru");
                        persons[1] = new Person("Sidorov", "Sidr", "74953334453", "mail4453@yandex.ru");
                        persons[2] = new Person("Andreev", "Andrey", "74953334222", "mail212@yandex.ru");
                        persons[3] = new Person("Petrov", "Petr", "74953334111", "mail400@yandex.ru");
                        persons[4] = new Person("Bondarev", "Bondar", "74953334234", "mail23w@yandex.ru");
                        persons[5] = new Person("Galinova", "Galina", "74953334213", "mail2dd2@yandex.ru");
                        persons[6] = new Person("Klavdieva", "Klavdia", "74953334210", "mail2354@yandex.ru");
                        persons[7] = new Person("Semebova", "Irina", "74953334217", "mail23459@yandex.ru");
